...
import corus.shortlinker.web.page.LinkPage;
import corus.shortlinker.web.page.NotFoundPage;
import corus.shortlinker.web.page.Page;
...
public class FrontServlet extends HttpServlet {
    ...
    private static final class Route {
        ...
        private static Route getIndexPageRoute(HttpServletRequest request) {
            String action = request.getParameter("action");
            return new Route(LinkPage.class.getName(), action != null && action.isEmpty() ? null : action);
        }
